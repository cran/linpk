...
Monolix](http://mlxtran.lixoft.com/wp-content/uploads/sites/2/2016/02/PKPDlibrary.pdf)
...
[mrgsolve](http://mrgsolve.github.io/),
[PKPDsim](http://pkpdsim.ronkeizer.com/), and
...
The package includes a small shiny app for interactive exploration. To run it,
the following packages must be installed:
[shiny](https://CRAN.R-project.org/package=shiny),
[shinyjs](https://CRAN.R-project.org/package=shinyjs),
[shinyAce](https://CRAN.R-project.org/package=shinyAce),
[dygraphs](https://CRAN.R-project.org/package=dygraphs). It can then be run by
the command:
...
The app will open in a browser. It looks like this:
...
Compared to more general ODE solvers ([mrgsolve](http://mrgsolve.github.io/),
